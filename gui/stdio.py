...
_ = lambda x:x
#from i18n import _
from electrum_stratis.wallet import WalletStorage, Wallet
from electrum_stratis.util import format_satoshis, set_verbosity, StoreDict
from electrum_stratis.stratis import is_valid, COIN, TYPE_ADDRESS
from electrum_stratis.network import filter_protocol
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Stratis address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-stratis setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-stratis setconfig' to change your settings")
        return True
